    ...
    public partial class recordPatDiagnosis : MetroForm
    {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string precriptionQuery = "INSERT INTO prescription (patientId, PrescriptionDate, PrescriptionDetails) VALUES ('"
                    + this.patientName_combobox.SelectedValue + "','"
                    + this.metroDateTime2.Value.ToString("yyyy/MM/dd") + "','"
                    + this.richTextBox4.Text +
                    "');";

                string referralQuery = "INSERT INTO patient_refferal (CheckUp_PatientID, RefferalDate, RefferalDescription) VALUES ('"
                    + this.patientName_combobox.SelectedValue + "','"
