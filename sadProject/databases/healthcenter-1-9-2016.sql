...
INSERT INTO `medical_supplies_inventory` VALUES (1,100,1397),(2,101,12),(3,102,10),(4,103,10),(5,104,10),(6,7758,10),(7,112415,0),(8,112415,10),(9,312314,10),(10,110,10),(11,110,10),(12,321,10),(13,887,10),(14,8871,10),(15,44771008,10),(16,911,0),(17,119,30);
...
--
-- Table structure for table `requisition_med_list`
--

DROP TABLE IF EXISTS `requisition_med_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `requisition_med_list` (
  `list_med` varchar(255) DEFAULT NULL,
  `IdmedList` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `requisition_med_list`
--

LOCK TABLES `requisition_med_list` WRITE;
/*!40000 ALTER TABLE `requisition_med_list` DISABLE KEYS */;
INSERT INTO `requisition_med_list` VALUES ('tambal na makaayo, yeah, 10',1,NULL),('bisagunsa, 12323, 10',2,NULL),('bisagunsa, 12323, 10',3,NULL),('bisagunsa, 12323, 10',4,NULL),('bisagunsa, 12323, 10',5,NULL),('bisagunsa, 12323, 10',6,NULL),('bullshit, tangina, 12',7,NULL),('bullshit, tangina, 12',8,NULL),('bullshit, tangina, 12',9,NULL),('tambal na makaayo, yeah, 10',10,NULL),('tambal na makaayo, yeah, 10',11,NULL),('tambal na makaayo, yeah, 10',12,NULL),('tambal na makaayo, yeah, 10',13,NULL),('tambal na makaayo, yeah, 10',14,NULL),('tambal na makaayo, yeah, 10',15,NULL),('tambal na makaayo, yeah, 10',16,NULL),('tambal na makaayo, yeah, 10',17,NULL),('tambal na makaayo, yeah, 10',18,NULL),('tambal na makaayo, yeah, 10',19,NULL),('bullshit, tangina, 10',20,NULL),('asdfasdf, asdfaw, 1',21,NULL),('bullshit, tangina, 12',22,NULL),('bullshit, tangina, 12123',23,NULL),('bullshit, tangina, ',24,NULL),('bullshit, tangina, 12',25,NULL),('bullshit, tangina, 12',26,NULL),('bullshit, tangina, 12',27,NULL),('bullshit, tangina, 12',28,NULL),('bullshit, tangina, 12',29,NULL),('bullshit, tangina, ',30,NULL),('bullshit, tangina, 12',31,NULL),('bullshit, tangina, 12',32,NULL),('bullshit, tangina, 12',33,NULL),('bullshit, tangina, 12',34,NULL),('bullshit, tangina, 12',35,NULL),('bullshit, tangina, 12',36,NULL),('tambal na makaayo, yeah, 32',37,NULL),('asdsadf, asdf, 12',38,NULL),('bullshit, tangina, 12',39,NULL),('paracetamol, tablet, 1',40,NULL),('bullshit, tangina, 12',41,NULL),('tambal na makaayo, yeah, 12',42,NULL),('bullshit, tangina, 12',43,99),('bullshit, tangina, 32',44,99),('bullshit, tangina, 32',45,99),('bullshit, tangina, 42',46,99),('paracetamol, tablet, 1',47,99),('bullshit, tangina, 12',48,99),('bullshit, tangina, 32',49,99),('bullshit, tangina, 32',50,99),('bullshit, tangina, 42',51,99),('paracetamol, tablet, 1',52,99),('paracetamol, tablet, 12',53,99),('ListViewItem: {bullshit, tangina, 12}',54,99),('ListViewItem: {bullshit, tangina, 12}',55,100),('ListViewItem: {bullshit, tangina, 12}',56,101),('ListViewItem: {bullshit, tangina, 12}',57,102),('bullshit, tangina, 12',58,106),('bullshit, tangina, 32',59,106),('tambal na makaayo, yeah, 12',60,106),('bullshit, tangina, 12',61,106),('bullshit, tangina, 32',62,106),('bullshit, tangina, 12',63,106),('bullshit, tangina, 32',64,106),('bullshit, tangina, 12',65,106),('bullshit, tangina, 12',66,106),('asdw, asdfdasdw, 1',67,106);
/*!40000 ALTER TABLE `requisition_med_list` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-01-09  4:21:49
